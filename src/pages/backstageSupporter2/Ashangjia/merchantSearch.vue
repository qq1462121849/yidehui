    ...
    <div :style="{paddingTop: statusH + 'rem'}">
      ...
      <div class="record-core-top">
        <div class="search-box">
          <div >
            ...
            <input type="text" v-model="keyword" placeholder="请输入商家名称">
          </div>
        </div>
        <div class="core-top-c">
          <div>
            <!-- <span>支付状态:</span> -->
            <checklist :title="'状态:'" :options="status" v-model="statusValue" @on-change="xuanze2"></checklist>  
          </div>
        </div>
      ...
      <div style="position: relative;" class="RecordCore">
        <div class="RecordCore-tit RecordCore-title">
          <div class="core-tit1">商家ID</div>
          <div class="core-tit3">商家账号</div>
          <div class="core-tit3">商家名称</div>
            ...
            <div class="RecordCore-tit-body">
              <div class="RecordCore-tit RecordCore-title1" v-for="(item,index) in list" :key="index">
                ...
                <div class="core-tit3">{{item.username}}</div>
                <div class="core-tit3 suojin">{{item.title}}</div>
                <div class="core-tit1 tit1Box" @click="jumpTo('/merGoodsDetail1?id='+item.id)">详情</div>
              </div>
            </div>
          </div>
      </div>
