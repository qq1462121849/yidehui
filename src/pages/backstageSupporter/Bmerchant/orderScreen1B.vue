    ...
    <div  :style="{paddingTop: statusH + 'rem'}">
      ...
      <div class="record-core-top">
        <div class="core-top-t">
          <div>
            ...
            <div class="core-top-le">
              <input type="text" v-model="cid" placeholder="请输入分类信息">
            </div>
          </div>
          <div>
            <div>商品名称</div>
        ...
        <div class="core-top-c">
          <div>
            <checklist :title="'商品状态:'" :options="status" v-model="statusValue" @on-change="xuanze2"></checklist>  
          </div>
        </div>
      ...
      <div style="position: relative;" class="RecordCore">
        <div class="RecordCore-tit RecordCore-title">
          <div class="core-tit1">商品编号</div>
          <div class="core-tit2">商品名称</div>
          <div class="core-tit1">商品价格</div>
            ...
            <div class="RecordCore-tit-body">
              <div class="RecordCore-tit RecordCore-title1" v-for="(item,index) in list" :key="index">
                <div class="core-tit1">{{item.id}}</div>
                <div class="core-tit2 sojin" >{{item.goodsName}}</div>
                <div class="core-tit1">{{item.ex_price}}</div>
                <div class="core-tit1 tit1Box" @click="jumpTo('/merGoodsDetail?id='+item.id)">详情</div>
              </div>
            </div>
          </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    upCallback(page, mescroll) {
      ...
      if (!this.keyword && !this.cid && this.statusValue.length=='0'){
        this.$nextTick(() => {
