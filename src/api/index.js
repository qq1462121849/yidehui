...
// }
// // 商家申请入驻协议
// export const applyShopAgreement = function () {
//   return http.post(mall + '/users/rules', {}, true)
// }
// // 个人商家申请提交信息
...
// export const applyConfirm = function (type, types, title, cid, model, username, mobile, province, city, district, address, logo, identification_card, number1, number2, hold_number) {
//   return http.post(mall + '/users/shops-applyfor', {type: type, types: types, title: title, cid: cid, model: model, username: username, mobile: mobile, province: province, city: city, district: district, address: address, logo: logo, identification_card: identification_card, number1: number1, number2: number2, hold_number: hold_number}, true)
// }
// // 企业商家申请提交信息
// // eslint-disable-next-line camelcase
// export const applyConfirmQiye = function (type, types, title, cid, model, username, mobile, province, city, district, address, logo, identification_card, number1, number2, corporate_name, code, licence) {
//   return http.post(mall + '/users/shops-applyfor', {type: type, types: types, title: title, cid: cid, model: model, username: username, mobile: mobile, province: province, city: city, district: district, address: address, logo: logo, identification_card: identification_card, number1: number1, number2: number2, corporate_name: corporate_name, code: code, licence: licence}, true)
// }
// // 个人中心信息返回
